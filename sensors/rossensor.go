...
var RosSensorModel = resource.NewModel("brokenrobotz", "ros", "senso")
...
func (e *RosSensor) processMessage(msg *std_msgs.Float32) {
	e.msg = msg
}

func (e *RosSensor) Readings(
	_ context.Context,
...
func (e *RosSensor) Close(_ context.Context) error {
	if e.subscriber != nil {
		e.subscriber.Close()
	}
	return nil
